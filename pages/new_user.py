...
translations = {
    ...
    "which_page": {"ENG": "Please check which pages you would like to include:", "POL": "Zaznacz jakie strony chcesz mieć:"},
    "page_1": {"ENG": "Trading", "POL": "Inwestowanie"},
    "page_2": {"ENG": "Real estate market", "POL": "Rynek nieruchomości"},
...
real_estate = st.checkbox(translations["page_2"][st.session_state.lang])

user_choice = []
if Trading:
    user_choice.append('T')
if real_estate:
    user_choice.append('R')

st.write('')
st.write('')
st.write('')

## Accept and Abort button
